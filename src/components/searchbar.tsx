...
export default function Searchbar() {
    return (
        <div className="flex flex-row cursor-text transition ease-in-out delay-10 w-1/2 h-14 bg-opacity-30 rounded-lg items-center text-white text-2xl border-white border-2">
